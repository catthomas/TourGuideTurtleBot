...
int main(int argc, char **argv) {
	...
	/* Define locations */
	definePoseStamped(&computer_lab, -8.0, -0.5);
	definePoseStamped(&west_doors, 12.0, 1.0);
	definePoseStamped(&east_doors, -16.0, 1.0);
	definePoseStamped(&ddl, 2.0, -0.5);
	definePoseStamped(&board_room, 8.0, 0.0);
